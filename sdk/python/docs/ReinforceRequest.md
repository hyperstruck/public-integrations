...
**is_delivered** | **object** | Whether the recall reached the model on this turn. Omit it and an absent &#x60;context_receipt&#x60; has two readings, a run that was shown its learnings and lost the evidence and a run that was never shown them at all, and only the first is a defect. NULL means the client did not say. | [optional]
