...
**metadata** | **object** | Optional caller-defined metadata attached to the run. | [optional]
**sources** | **object** | Source-of-truth text, such as a transcript or record set, that the response may rely on as evidence. | [optional]
