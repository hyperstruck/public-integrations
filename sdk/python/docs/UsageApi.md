...
[**get_tenant_llm_usage_breakdown_admin_usage_tenants_tenant_id_llm_breakdown_get**](UsageApi.md#get_tenant_llm_usage_breakdown_admin_usage_tenants_tenant_id_llm_breakdown_get) | **GET** /usage/tenants/{tenant_id}/llm/breakdown | Get Tenant Llm Usage Breakdown Admin
...
[**list_tenant_run_llm_calls_admin_usage_tenants_tenant_id_runs_run_id_calls_get**](UsageApi.md#list_tenant_run_llm_calls_admin_usage_tenants_tenant_id_runs_run_id_calls_get) | **GET** /usage/tenants/{tenant_id}/runs/{run_id}/calls | List Tenant Run Llm Calls Admin
...
# **get_tenant_llm_usage_breakdown_admin_usage_tenants_tenant_id_llm_breakdown_get**
> UsageLlmBreakdownResponse get_tenant_llm_usage_breakdown_admin_usage_tenants_tenant_id_llm_breakdown_get(tenant_id, window=window, as_of=as_of)

Get Tenant Llm Usage Breakdown Admin
...
try:
    # Get Tenant Llm Usage Breakdown Admin
    api_response = api_instance.get_tenant_llm_usage_breakdown_admin_usage_tenants_tenant_id_llm_breakdown_get(tenant_id, window=window, as_of=as_of)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling UsageApi->get_tenant_llm_usage_breakdown_admin_usage_tenants_tenant_id_llm_breakdown_get: %s\n" % e)
```
...
[**UsageLlmBreakdownResponse**](UsageLlmBreakdownResponse.md)
...
# **list_tenant_run_llm_calls_admin_usage_tenants_tenant_id_runs_run_id_calls_get**
> UsageLlmCallListResponse list_tenant_run_llm_calls_admin_usage_tenants_tenant_id_runs_run_id_calls_get(tenant_id, run_id, limit=limit, cursor=cursor)

List Tenant Run Llm Calls Admin
...
try:
    # List Tenant Run Llm Calls Admin
    api_response = api_instance.list_tenant_run_llm_calls_admin_usage_tenants_tenant_id_runs_run_id_calls_get(tenant_id, run_id, limit=limit, cursor=cursor)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling UsageApi->list_tenant_run_llm_calls_admin_usage_tenants_tenant_id_runs_run_id_calls_get: %s\n" % e)
```
...
[**UsageLlmCallListResponse**](UsageLlmCallListResponse.md)
