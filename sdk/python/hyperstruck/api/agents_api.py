...
class AgentsApi(object):
    ...
    def delete_agent_endpoint_agents_agent_id_delete(self, agent_id, **kwargs):  # noqa: E501
        ...
        Permanently delete a hosted agent and purge its learning corpus after the row commits. Use only when the agent and its configuration are no longer needed; the operation cannot be undone.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
