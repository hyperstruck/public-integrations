...
class LearningsApi(object):
    ...
    def delete_agent_learnings_endpoint_agents_agent_id_learnings_delete(self, agent_id, **kwargs):  # noqa: E501
        ...
        Delete every learning memory scoped to the agent. Requires the agents:write scope and can_write on the agent. This is a destructive operation and does not affect other memory categories or the org-shared learning library.  # noqa: E501
