...
class LearningAuditItem(object):
    ...
    @property
    def source(self):
        """Gets the source of this LearningAuditItem.  # noqa: E501

        How this learning was produced: `llm_extracted`, `auto_derived` or `pattern_synthesised`. This is the extraction method, not the provenance of the material: it distinguishes a synthesised pattern from an extracted rule, and it is what answers how much of a corpus synthesis actually produced. For the originating goal text, read `source_goal` on the detail endpoint.  # noqa: E501

        :return: The source of this LearningAuditItem.  # noqa: E501
        :rtype: object
        """
        return self._source
    ...
    def source(self, source):
        """Sets the source of this LearningAuditItem.

        How this learning was produced: `llm_extracted`, `auto_derived` or `pattern_synthesised`. This is the extraction method, not the provenance of the material: it distinguishes a synthesised pattern from an extracted rule, and it is what answers how much of a corpus synthesis actually produced. For the originating goal text, read `source_goal` on the detail endpoint.  # noqa: E501

        :param source: The source of this LearningAuditItem.  # noqa: E501
        :type: object
        """
        if source is None:
