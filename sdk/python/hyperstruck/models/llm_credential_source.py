...
class LlmCredentialSource(object):
    ...
    CUSTOMER_TENANT_DEFAULT = "customer_tenant_default"
    ...
    def __init__(self):  # noqa: E501
        """LlmCredentialSource - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(LlmCredentialSource, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, LlmCredentialSource):
            return False
