...
class AgentResponse(object):
    ...
    def __init__(self, core_config=None, created_at=None, description=None, home_space_id=None, id=None, name=None, reasoning_profile=None, status=None, updated_at=None):  # noqa: E501
