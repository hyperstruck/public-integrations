...
class AgentResponse(object):
    ...
    def __init__(self, id=None, name=None, description=None, status=None, reasoning_profile=None, home_space_id=None, core_config=None, created_at=None, updated_at=None):  # noqa: E501
